                ...
                <div className="container-form-register">
                    ...
                    <form className="form-register" onSubmit={ handleSubmit( onSubmit ) }>
                        ...
                        <div className="container-block-register-primary">
                            ...
                            <div className="container-block-register">
                                ...
                                <div className="container-register">
                                    ...
                                    <label
                                        ...
                                        className="label-form-register"
                                    >
                                        <IntlMessages id="form.hotel"/><span className="required-label">*</span>
                                    </label>
                                    ...
                                    <input
                                        ...
                                        name="hotel"
                                        autoComplete="off"
                                        className="input-register-hotel"
                                ...
                                <div className="container-register">
                                    ...
                                    <label
                                        ...
                                        className="label-form-register"
                                    >
                                        <IntlMessages id="form.Room"/><span className="required-label">*</span>
                                    </label>
                            ...
                            <div className="container-block-register-motive-proof">
                                
                                <div className="container-motive-proof-register-primary">
                                    ...
                                    <div className="container-motive-proof-register-control">
